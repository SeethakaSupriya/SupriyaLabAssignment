...
Author:Supriya 
Date:23/10/2020
Desc:Create a method that can accept an array of String objects and sort in alphabetical order. 
*/
import java.util.*;
...
public class AlphabeticalOrder {
	...
	public static void main(String[] args) {
		...
		System.out.println("The Result of the String is" +res1.toUpperCase()+res2.toLowerCase());
