...
public class StudentMarks {
	...
	private static Map<Integer, String> getStudents(Map<Integer, Integer> student) {
		...
		/**
		 * checks the marks 
		 * if the marks is more than 90 then display gold medal 
		 * if the marks is greater than 80 and less than 90 then display silver medal 
		 * if the marks is greater than 70 and less than 80 then display Bronze
		 */
